...
<section class="py-5">
    <form action="{{ route('update-service', $services->id) }}" method="post" enctype="multipart/form-data" >
        ...
        <div class="row mb-3 ">
            ...
            <div class="col-md-7">
                <input type="text" class="form-control" name="title" value="{{ $services->title }}" placeholder="Type Titile">
            </div>
        </div>
        <div class="row mb-3 ">
            <label class="col-md-3 text-center"><b>Description</b></label>
            <div class="col-md-7">
                <textarea name="description" class="form-control" placeholder="Type Description">{{ $services->description }}</textarea>
            </div>
        </div>
        <div class="row mb-3 shadow">
            ...
            <div class="col-md-7">
                ...
                <img style="width: 70px" src="{{ asset('images/'.$services->image) }}" alt="">
            </div>
        </div>
        <div class="row mb-3">
